...
class Auth0SigninScreen extends StatefulWidget {
  const Auth0SigninScreen({Key? key}) : super(key: key);

  @override
  State<Auth0SigninScreen> createState() => _Auth0SigninScreenState();
}

class _Auth0SigninScreenState extends State<Auth0SigninScreen> {
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Sign in to your PetForm account',
                          style: TextStyle(
                            fontSize: 16,
